...
public class ActivitiJavaTest {
	 ...
	 * 2、部署流程；（流程图信息存储到数据库）
	 */
	//部署成功DeploymentEntity[id=112501, name=null]
	//部署成功DeploymentEntity[id=107501, name=null]
	//部署成功DeploymentEntity[id=142501, name=null]
	@Test
	public void deployTest() {
		...
		Deployment deployment = repositoryService.createDeployment()
			.addClasspathResource("java.bpmn")
			.deploy();
