      ...
      <div class="page-header">
		...
		<form role="form" style="margin-top:20px;">
		  ...
		  <div class="form-group">
			...
			<input type="text" class="form-control" 
				id="idcardInput" placeholder="请输入身份证号码">
		  </div>
		  <div class="form-group">
          ...
          <button type="button" onclick="window.location.href='${ctp}/auth/step01.html'" class="btn btn-default">上一步</button>
        ...
        <div class="container" style="margin-top:20px;">
  		...
  		<script type="text/javascript">
  			$("#nextBtn").click(function(){
  				...
  				var pd = {realname:$("#realnameInput").val(),idcard:$("#idcardInput").val(),token:ud.content.token};
  				//保存基本信息
  				$.post("http://localhost:8082/rest-api/member/center/baseinfo",pd,function(data){
  					location.href='${ctp}/auth/step03.html'
  				});
  			});
  		</script>
  </body>
