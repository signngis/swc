      ...
      <div class="page-header">
		...
		<form role="form" style="margin-top:20px;">
		  <div class="form-group">
			...
			<input type="text" class="form-control" id="codeInput" placeholder="请输入你邮箱中接收到的验证码">
		  </div>
  ...
  <%@include file="/WEB-INF/include/common-js.jsp" %>
	<script>
		...
		$("#nextBtn").click(function(){
			...
			$.get("http://localhost:8082/rest-api/member/center/validate/code",
					{token:ud.content.token,code:$("#codeInput").val()},
					function(data){
						if(data.code==0){
							location.href="${ctp}/member/center";
						}else{
							alert(data.msg);
						}
