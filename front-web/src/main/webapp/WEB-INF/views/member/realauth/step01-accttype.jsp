...
.seltype {
 ...
 <div class="navbar-wrapper">
	...
	<button id="nextBtn" type="button" class="btn btn-danger btn-lg btn-block">
			认证申请
	</button>
    </div> <!-- /container -->
      <!-- /END THE FEATURETTES -->
   	...
   	$("#nextBtn").click(function(){
   		...
   		//1、發送請求保存账户类型
   		var pd = {accttype:accttype,token:ud.content.token};
   		$.post("http://localhost:8082/rest-api/member/center/accttype",pd,function(data){
   			location.href="${ctp}/auth/step02.html";
   		});
   	});
