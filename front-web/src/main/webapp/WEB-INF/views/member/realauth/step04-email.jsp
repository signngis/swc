 ...
 <div class="navbar-wrapper">
      ...
      <div class="page-header">
		...
		<form role="form" style="margin-top:20px;">
		  <div class="form-group">
			...
			<input type="text" class="form-control"  id="emailInput" disabled="disabled">
		  </div>
          <button type="button" onclick="window.location.href='${ctp}/auth/step03.html'" class="btn btn-default">上一步</button>
  ...
  <%@include file="/WEB-INF/include/common-js.jsp" %>
	<script>
		...
		//onclick="window.location.href='${ctp}/auth/step05.html'" 
		$("#nextBtn").click(function(){
			$.get("http://localhost:8082/rest-api/member/center/code",{token:ud.content.token},function(){
				window.location.href='${ctp}/auth/step05.html';
			})
		});
		...
		$(function(){
			...
			$("#emailInput").val(ud.content.email);
		})
